...
The list above is filtered to the `ready-for-agent` label — this repo's canonical
"agent-ready" signal (see `docs/agents/triage-labels.md`). These issues have already
been triaged; do NOT re-triage them or second-guess whether they belong here. Your
only job is dependency analysis and branch assignment.
